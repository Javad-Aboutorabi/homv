...
public class contact2 {
    public static void main(String[] args) {
       ...
       contact hossein = new contact("hossein","movaghari",911111111,170000000,"hm@gmail.com","gorgan molaghati","single") ;
       contact reza =new contact("reza","siahbalei",911222222,171171717,"rs@gmail.com","gorgan ojaben     ","in rel");
       contact mamad = new contact("mamad","zakeri     ",911333333,174654463,"mz@gmail.com","gorgan sayyad","    married");
